...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: app.d.ceshiUrl + '/Api/payment/buy_now',
      method: 'post',
      data: parm,
      header: {
  ...
  createProductOrder: function () {
    ...
    wx.request({
      ...
      data: {
        ...
        aid: that.data.address.id,//地址的id
        ...
        if (res.data.status == 1) {
          ...
          wx.requestPayment({
            ...
            success: function (res) {
              ...
              wx.request({
                url: app.d.ceshiUrl + '/Api/payment/pay_edit',
                header: {
                  'Content-Type': 'application/x-www-form-urlencoded'
                },
                method: 'POST',
                ...
                success: function(res) {
                  wx.request({
                    ...
                    method: 'POST',
                    data: { uid: that.data.userId, pid: that.data.pid, num: that.data.num },
                    success: function (res) {
                    },
